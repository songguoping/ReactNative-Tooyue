package com.codersong.tooyue.feedback;

import com.alibaba.sdk.android.feedback.impl.FeedbackAPI;
import com.codersong.tooyue.utils.TextSizeUtils;
...
public class FeedBackModule extends ReactContextBaseJavaModule {
    ...
    public void openFeedbackActivity(ReadableMap poiData) {
       if(poiData != null) {
        ...
        FeedbackAPI.setTitleBarHeight(TextSizeUtils.dip2px(mReactContext, 50));
